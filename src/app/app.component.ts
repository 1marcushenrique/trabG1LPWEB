...
export class AppComponent {
    ...
    ocorrencias = [
        new Ocorrencia(1,'Frederico Matheus',new Tipo(3, 'indicação de atenção por assunto familiar, psicológico ou social'),"2018-04-25"),
        new Ocorrencia(2,'Gilson Ferrenta',new Tipo(2, 'baixo índice de rendimento'),"2018-03-26"),
        new Ocorrencia(3,'Gaspar Ferreira',new Tipo(1, 'comportamento inadequado com colegas'),"2018-03-02"),
        new Ocorrencia(3,'Gaspar Ferreira',new Tipo(1, 'comportamento inadequado com colegas'),"2018-04-09"),
        new Ocorrencia(5,'Hevelin Judite',new Tipo(0, 'indisciplina em sala de aula'),"2018-04-10"),
        new Ocorrencia(1,'Frederico Matheus',new Tipo(3, 'indicação de atenção por assunto familiar, psicológico ou social'),"2018-03-27")
    ];
    tipos = [
    ...
    alunos=[
        new Aluno(1, 'Frederico Matheus'),
        new Aluno(2, 'Gilson Ferrenta'),
        new Aluno(3, 'Gaspar Ferreira'),
        new Aluno(4, 'Gean Castro'),
        new Aluno(5, 'Hevelin Judite'),
    ]
    exibir_lista(){
